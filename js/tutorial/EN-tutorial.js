	...
	window.json = { //declared global
		...
		tutorial: {
            ...
            "scoring": {
                ...
                "3": "The alignment score estimates the similarity between a sequence and its ancestor. A color match brings you a bonus of +1 and a color mismatch costs you a penalty of -1. The creation of a gap has a penalty of -4 and its extension by one unit costs -1. However, gaps at the extremities are not considered. Empty columns are ignored. Here, the alignment score between the elephant and its ancestor is -5 (4 matches, 4 mismatches, 1 gap of length 1).",
