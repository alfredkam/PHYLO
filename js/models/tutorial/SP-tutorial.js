{
   "tutorial":{
      "basics":{
         ...
         "7":"La información del juego se encuentra disponible en la parte inferior del tablero de juego. La barra azul indica su puntuación actual. La marca roja indica el par (i.e. el puntaje a superar) y la marca verde muestra el mejor puntaje que usted ha obtenido hasta el momento.",
      ...
      "scoring":{
         ...
         "3":"La puntuación del alineamiento calcula la similitud entre una secuencia y su antecesor. Un concordancia de color le otorga un bonus de +1 y una discordancia le cuesta una sanción de -1. La creación de un espacio tiene una penalización de -4 y su extensión le cuesta -1 por cada unidad. Los espacios en los extremos no son penalizados y las columnas vacias son ignoradas. En el ejemplo, el puntaje del alineamiento entre el elefante y su ancestro es -3 (4 concordancias, 1 disconcordancias, 1 espacio de longitud 3).",
