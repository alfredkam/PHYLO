	...
	window.json = { //declared global
		...
		tutorial: {
            ...
            "scoring": {
            		...
            		"field 4": "Sua pontuação é a soma das pontuações dos alinhamentos de cada sequência com sua ancestral imediata. No exemplo, a pontuação é a soma das comparações entre a ancestral de B com humano e chimpanzé, da ancestral C com cão e morcego, a da ancestral A com B e C.", 
            },
            "example": {
		"field 1": "Mão na massa: Um exemplo.",
		"field 2": "Você começa com duas sequências (humano e chimpanzé). Arraste tudo para a esquerda e observe a ancestral. Alinhar esta ancestral com suas duas sequências resulta em 13 concordâncias para a primeira sequência (humano), e 5 concordâncias, 1 discordância, e 1 lacuna de extensão 7 para a segunda sequência (chimpanzé), levando a um total de 18 × (+1) + 1 × (‐1) + (‐5 + 6 × (‐1)) = 6. Você passa do mínimo. Clique na estrela e passe para a próxima fase!",
		"field 3": "Duas novas sequências (cão e morcego) aparecem. Novamente, arraste-as para a esquerda. Sua pontuação é 4. 18 concordâncias e 1 lacuna de extensão 1 entre a sequência do cão e sua ancestral, e 5 concordâncias e 14 discordâncias entre a sequência do morcego e a mesma ancestral, (logo um total de 23 × (+1) + 14 × (‐1) + (‐5) = 4). Você pode melhorar isso. Como?",
            		"field 4": "Traga a sequência de baixo uma casa para a esquerda a partir do sétimo bloco. Você cria uma nova lacuna mas também cria muitas novas concordâncias. E viu só? A ancestral mudou. Você agora tem 18 concordâncias e 1 lacuna de extensão 2 para a sequência do cão, e 12 concordâncias, 7 discordâncias e 1 lacuna de extensão 1 para a sequência do morcego. Sua pontuação é 30 × (+1) + 7 × (‐1) + ( 2 × ‐5 + 1 × (-1)) = 12. Passe para a próxima fase.",
            		"field 5": "Agora, você precisa montar seus alinhamentos anteriores. Sua pontuação inicial é 14. Não vence o mínimo (19)… Intuitivamente, queremos chegar a uma alinhamento melhor entre o primeiro bloco (as duas sequências de cima) e o segundo bloco (as duas de baixo). Como?",
            		"field 6": "Mova o primeiro bloco 4 casas para a direita. Isto cria duas colunas totalmente verdes. Com isso a similaridade entre sequência humana e as do cão e do morcego aumenta. Sua pontuação total aumenta para 26. Como este número é calculado?",
            		"field 7": "Vejamos a ancestral do humano e do chimpanzé. A pontuação do seu alinhamento com a sequência humana é 11 (12 concordâncias e 1 discordância), e -5 com a sequência do chimpanzé (6 concordâncias e 1 lacuna de extensão 7). Logo a pontuação desta ancestral é 11 + (-5) = 6.",
            		"field 8": "Façamos o mesmo para a ancestral do cão e do morcego. A pontuação do seu alinhamento com a sequência do cão é 14 (16 concordâncias e 2 discordâncias) and -4 com a sequência do morcego (12 concordâncias, 5 discordâncias, 1 lacuna de extensão 1, e 1 lacuna de extensão 2). Logo, a pontuação para este nó ancestral é 14 + (-4) = 10",
            		"field 9": "Para completar o cálculo da pontuação, precisamos computar a pontuação do alinhamento da ancestral humano/chimpanzé e da a ancestral cão/morcego com a ancestral na raiz da árvore. Primeiro, computemos a pontuação do alinhamento da ancestral humano/chimpanzé com a ancestral global. Há 9 concordâncias, 4 discordâncias, 1 lacuna de extensão 4 e 1 lacuna de extensão 1. A pontuação é 9 × (+1) + 4 × (‐1) + ( 2 × ‐5 + 3 × (-1)) = -8.",
            		"field 10": "Agora, computemos a pontuação do alinhamento da ancestral cão/morcego com a ancestral global. Há 18 concordâncias, e a pontuação é 18. Portanto, a pontuação total associada à raiz é (-8) + 18 = 10.",
            		"field 11": "Sua pontuação final é a soma de todas as pontuações individuais obtidas anteriormente. Encontra-se resumida na árvore, onde cada nó exibe a pontuação do alinhamento entre seus descendentes. Neste caso, a pontuação do alinhamento entre humano e chimpanzé é 6, a pontuação do alinhamento entre cão e morcego é 10, e a pontuação do alinhamento dos ancestrais com a raiz é 10. Com isso, sua pontuação total é 26, exibida na raiz da árvore.",
            		"field 12": "Você obteve a pontuação máxima. Clique na estrela e envie sua solução. Pronto! O número deste puzzle é 3847. Agora, você está pronto para jogar!",
            },
            "misc": {
                "field 1": "concordância",
                "field 2": "discordância",
                "field 3": "lacuna",
                "field 4": "árvore filogênica",
            },
