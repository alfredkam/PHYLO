...
var V_W = 930;	// viewer width (original: 880)
var V_H = 220;	// viewer height

var T_W = 155; // tree area width (orginal: 135)
var T_H = 220; // tree area height
var T_SIZE_H = 15;   // size of one level in the tree
var T_THICKNESS = 1;
var T_COLOUR = "rgb(74,74,74)";//"rgb(240,240,240)";
...
var G_ROW = 12;	// grid row
var G_COL = 600;	// grid col
var G_COLOUR = "rgb(74,74,74)";//"rgb(240,240,240)";	//grid colour
var G_COLOUR_A = "rgba(74,74,74,0)";//"rgba(240,240,240,0)";	//grid colour, full alpha
...
var VP_W = 600 * 3;	// viewer width (original: 293 * 3)
var VP_H = 12 * 3;	// viewer height (original: 10 * 3)
...
var V_ANCESTOR_ROW = 11;     // which row the ancestor appears (original: 9)
