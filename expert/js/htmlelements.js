                    ...
                    "callback": function() {
                        if ($.cookie.read("username")) {
                            ...
                            if (provider=="Facebook") {
                                ...
                                var message = fullname.replace("+"," ") + " used Phylo and improved a DNA alignments related to \"" + puzzle_disease + "\". http://phylo.cs.mcgill.ca";
                                var data = "provider="+provider+"&id="+c_logid+"&description="+message;
