...
<script type="text/javascript" src="js/dcanv.all.min.js"></script>
</head> 
<body> 
...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container">
            <ul class="nav">
                <li id="menu-play" class="active"><a href="#">Play</a></li>
                <li id="menu-highscores"><a href="#">Highscores</a></li>
...
<div id="messagebox-wrapper">
    <span id="stats-toggle" data-toggle="collapse" data-target="#stats-div">Toggle Details</span>
